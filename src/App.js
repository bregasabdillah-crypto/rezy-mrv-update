...
const TRANSLATIONS = {
  en: {
    ...
    collector: "Waste Collector", weighingEquip: "Weighing Equipment",
  ...
  id: {
    ...
    chainOfCustody: "Rantai Penjagaan",
    // Stage 1
    ...
    collector: "Pengepul Sampah", weighingEquip: "Alat Timbang",
...
export default function RezyMRVLive() {
  ...
  async function submitTransport() {
    ...
    if (!requireFields([
      ...
      { ok: activeId || Boolean(directMeta.collectorId), label: "Waste Collector" },
