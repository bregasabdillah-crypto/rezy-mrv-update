...
function normalizeSheetBatch(row) {
  ...
  return {
    ...
    notes: pickField(row, ["notes", "Notes", "Notes / Field Observations"]),
    vvb: pickField(row, ["vvb", "VVB"]),
    eprBuyer: pickField(row, ["eprBuyer", "EPR Buyer", "EPR Credit Buyer"]),
    verifierRef: pickField(row, ["verifierRef", "Verifier Ref", "VVB Audit Ref."]),
    creditsTonnes: pickField(row, ["creditsTonnes", "Credits (MT)"]),
    pprsSerial: pickField(row, ["pprsSerial", "creditSerial", "Credit Serial", "Serial"]),
    issuedAt: pickField(row, ["issuedAt", "Issued At"]),
...
const DEVICE_STRINGS = {
  en: {
    ...
    gpsDeniedBody: "Please turn on your location to use the Rezy MRV app.",
  ...
  id: {
    ...
    gpsDeniedBody: "Mohon aktifkan lokasi Anda agar dapat menggunakan aplikasi Rezy MRV",
